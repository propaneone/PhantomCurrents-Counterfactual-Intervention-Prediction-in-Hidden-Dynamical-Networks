...
outcome token sequence computed by simulating the hidden system past the
...
| Train | 5,800 | Labeled episode -> outcome token sequence pairs |
...
the 10-entity outcome token sequence (`E01=mid|...`) or `absent`. Hidden
